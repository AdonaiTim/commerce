	...
	*/
		...
		foreach ($element_array as  $fc){
			if (!array_intersect($fc[$element], $result)) {
				...
				if($element_key == $values  ){
					...
					$fieldType  .= '<span class="type fa active" data-keylayout="'.$keylayout.'" data-'.$element.'="'.$element_key.'"><img src="'.DIR_SOCONFIG.'images/desktop/'.$element.$element_key.'.jpg" alt="'.$element.$element_key.'"/></span>';
				}else{
					$fieldType  .= '<input type="radio" name="'.$names.'" value="'.$element_key.'" >';
					$fieldType  .= '<span class="type fa" data-keylayout="'.$keylayout.'" data-'.$element.'="'.$element_key.'"><img src="'.DIR_SOCONFIG.'images/desktop/'.$element.$element_key.'.jpg" alt="'.$element.$element_key.'"/></span>';
				}
				$fieldType  .= '</label>';
	...
	function field_mtypelayout($nameconfig,$element,$element_array,$columns= null){
		...
		foreach ($element_array as  $fc){
			...
			if($fc['key'] == $values){
				$fieldType  .= '<input  type="radio" name="'.$names.'" value="'.$fc['key'].'" checked  >';
				$fieldType  .= '<span class="type fa active" data-keylayout="'.$keylayout.'" data-keyheader="'.$keyheader.'" data-keyfooter="'.$keyfooter.'" ><img  src="'.DIR_SOCONFIG.'images/mobile/'.$element.$fc['key'].'.jpg" alt="'.$element.$fc['key'].'"/></span>';
			}else{
				$fieldType  .= '<input type="radio" name="'.$names.'" value="'.$fc['key'].'" >';
				$fieldType  .= '<span class="type fa" data-keylayout="'.$keylayout.'" data-keyheader="'.$keyheader.'" data-keyfooter="'.$keyfooter.'"><img src="'.DIR_SOCONFIG.'images/mobile/'.$element.$fc['key'].'.jpg" alt="'.$element.$fc['key'].'"/></span>';
			}
			$fieldType  .= '</label>';
	...
	function field_mtypeheader($nameconfig,$element,$element_array,$columns= null){
		...
		foreach ($element_array as  $fc){
			if (!array_intersect($fc[$element], $result)) {
				...
				if($element_key == $values  ){
					$fieldType  .= '<input type="radio" name="'.$names.'" value="'.$element_key.'" checked  >';
					$fieldType  .= '<span class="type fa active" data-keylayout="'.$keylayout.'" data-'.$element.'="'.$element_key.'"><img src="'.DIR_SOCONFIG.'images/mobile/'.$element.$element_key.'.jpg" alt="'.$element.$element_key.'"/></span>';
				}else{
					$fieldType  .= '<input type="radio" name="'.$names.'" value="'.$element_key.'" >';
					$fieldType  .= '<span class="type fa" data-keylayout="'.$keylayout.'" data-'.$element.'="'.$element_key.'"><img src="'.DIR_SOCONFIG.'images/mobile/'.$element.$element_key.'.jpg" alt="'.$element.$element_key.'"/></span>';
				}
				$fieldType  .= '</label>';
	...
	*/
	...
	function field_langTextarea($languages ,$nameconfig,$element){
		...
		foreach ($languages as $language){
			...
			$fieldLangTextarea .='<textarea data-lang="'. $language['locale'] .'" name="'.$names.'" data-toggle="summernote" id="input-description-'.$element.$language['language_id'].'">';
