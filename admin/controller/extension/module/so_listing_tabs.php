...
class ControllerExtensionModuleSolistingtabs extends Controller {
	...
	// Get Module Id new 
		...
		$data['store_layouts'] = array(
			...
			'style2' 	=> $this->language->get('value_style2')	,
			'style3' 	=> $this->language->get('value_style3'),
			'style4' 	=> $this->language->get('value_style4'),
			'style5' 	=> $this->language->get('value_style5'),
			'style6' 	=> $this->language->get('value_style6'),
		);
