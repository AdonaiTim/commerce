...
class ModelExtensionModuleSomegamenu extends Model {
    ...
    public function getCategories($array = array()) {
		...
		$num=(empty($array['categories']) || !isset($array['categories']) || !is_array($array['categories'])) ? 0 : count($array['categories']);
		$limit = (isset($array['limit']) && $array['limit']) ? $array['limit'] : $num;
       for ($i = 0; $i < $num;) {
