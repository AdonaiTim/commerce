...
class ControllerExtensionModuleSolistingtabs extends Controller {
	public function index($setting) {
		...
		//$data['display_dots'] 		= (int)$setting['display_dots'] > 0 ? 'true' : 'false' ;
		...
		$folder_cache = DIR_CACHE.'so_ListingTabs/';
		...
		if($is_ajax && isset($_POST['is_ajax_listing_tabs']) && $_POST['is_ajax_listing_tabs']){
			...
			$display_dots 				= (int)$setting['display_dots'] > 0 ? 'true' : 'false' ;
			...
			$twig = new Twig_Environment($loader, array('cache'=>DIR_CACHE.'so_ListingTabs/'));
			$data_template = array(
				'objlang'				=> $objlang,
				'type_show' 			=> $type_show,
